    ...
    <div className="flex flex-wrap justify-center">
      <ul className="w-[50%] divide-y divide-gray-200 mt-28 dark:divide-gray-700">
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://global.oup.com/?cc=uz" target="_blank">
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://www.tandfonline.com/  " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black truncate ">
                  <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://www.ariessys.com/ " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black truncate ">
                  <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://www.springerpub.com/ " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black truncate ">
                  <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://ethos.bl.uk/Home.do " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="http://www.netd.ac.za/   " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://ndltd.org/  " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
                    <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://etd.ohiolink.edu/  " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://oatd.org/   " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://trove.nla.gov.au/ " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
                    <font>TROVE</font>
                  </font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://ucla.on.worldcat.org/discovery " target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
                    <font>Melvil</font>
                  </font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://ora.ox.ac.uk/" target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="http://etheses.lse.ac.uk/" target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
        ...
        <li className="pb-3 sm:pb-4">
          <div className="flex items-center space-x-4 mt-3">
            <div className="flex-1 min-w-0">
              <a href="https://www.lib.cam.ac.uk/newton" target="_blank">
                <p className="text-2xl flex items-center hover:underline font-bold text-black ">
                  <font>
                    <font>
