...
function Quiz({ quiz }) {
  ...
  return (
    <div className="md:flex bg-gray-200 rounded-xl p-4 relative">
      <div className="relative">
        <div className="bg-white absolute bottom-0 left-0 right-0 p-2 bg-opacity-25 backdrop-filter backdrop-blur-lg">
          ...
          <h3 className="text-xs text-black font-semibold uppercase">
      ...
      <div className="md:px-4">
        ...
        <button
          className="absolute bottom-2 right-2 md:bottom-4 md:right-4 text-blue-500 text-lg flex items-center"
